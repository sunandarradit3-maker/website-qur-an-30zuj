...
const verses = [
  ...
  { n: 2, text: 'الْحَمْدُ لِلَّهِ رَبِّ الْعَالَمِينَ', trans: 'Segala puji bagi Allah, Tuhan seluruh alam.' },
  { n: 3, text: 'الرَّحْمَٰنِ الرَّحِيمِ', trans: 'Yang Maha Pengasih, Maha Penyayang.' },
  { n: 4, text: 'مَالِكِ يَوْمِ الدِّينِ', trans: 'Pemilik hari pembalasan.' },
  { n: 5, text: 'إِيَّاكَ نَعْبُدُ وَإِيَّاكَ نَسْتَعِينُ', trans: 'Hanya kepada Engkaulah kami menyembah dan hanya kepada Engkaulah kami mohon pertolongan.' },
  { n: 6, text: 'اهْدِنَا الصِّرَاطَ الْمُسْتَقِيمَ', trans: 'Tunjukilah kami jalan yang lurus.' },
  { n: 7, text: 'صِرَاطَ الَّذِينَ أَنْعَمْتَ عَلَيْهِمْ غَيْرِ الْمَغْضُوبِ عَلَيْهِمْ وَلَا الضَّالِّينَ', trans: 'Yaitu jalan orang-orang yang telah Engkau beri nikmat, bukan jalan mereka yang dimurkai dan bukan pula jalan mereka yang sesat.' }
];
